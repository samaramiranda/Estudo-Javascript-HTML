...
(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, "Samara de Lourdes Miranda"))
  ...
  */
  ...
  console.log(text.replace(/brasileiro/g, "anapolina"))
  ...
  */
  ...
  console.log(text.replace(/(O Centauro de Luvas)/g, function (capturaTotal, letra) {
